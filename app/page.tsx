      ...
      {showLanding && (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-zinc-950 overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-4xl">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 drop-shadow-lg">
              Why prompt… when your data can speak?
            </h1>
            <p className="text-xl md:text-2xl text-zinc-400 mb-10 font-medium">
              Your files already have the answers.
            </p>
            <button
              onClick={() => setShowLanding(false)}
              className="px-10 py-4 rounded-full bg-purple-600 text-white font-bold text-xl hover:bg-purple-500 hover:scale-105 transition-all shadow-[0_0_30px_rgba(168,85,247,0.5)]"
            >
              Get Started
            </button>
          </div>
